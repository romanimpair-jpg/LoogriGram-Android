        ...
        button.setOnClickListener(v -> {
            ...
            fragment.setDelegate((fragment1, dids, _message, param, notify, scheduleDate, scheduleRepeatPeriod, topicsFragment) -> {
                ...
                for (MessagesStorage.TopicKey key : dids) {
                    ...
                    SendMessagesHelper.prepareSendingBotContextResult(lastFragment, AccountInstance.getInstance(currentAccount), message.result, params, dialogId, replyToMsg, replyToMsg, null, null, notify, scheduleDate, 0, null, 0);
                    if (_message != null) {
