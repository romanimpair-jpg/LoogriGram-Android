...
//                }
//            }
            // LoogriGram: prices come from the server's gift options. The Play
            // product query that used to fill them in is gone.
    ...
    private void onGiftPremium() {
        ...
        // Telegram's own invoice bot link, which is what it already did here.
