...
public class StickerCell extends FrameLayout {
    ...
    public StickerCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setFocusable(true);
        // LoogriGram: a premium sticker drew a padlock here without Premium (a
        // star badge with it). Premium is honoured for nobody, and premium
        // stickers are left out of every sticker list, as on desktop
