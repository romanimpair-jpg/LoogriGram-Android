...
public class ChooseQualityLayout {
    ...
    public static class QualityIcon extends Drawable {
        ...
        // LoogriGram: a "casting" state lived here - a filled cast glyph that
        // replaced the top label while a Chromecast session played. Nothing can
        // cast now, so the icon is always in its plain state.
